...
export interface CreateAgentSessionOptions {
	...
	/** Built-in tools to use. Default: all standard tools [read, bash, edit, write, grep, find, git, ls, web_search, web_fetch, subagent, wait, watch_github_ci, ask_user]. `skill`, `tasks_update`, and `search` are always active regardless of this setting. */
	tools?: Tool[];
